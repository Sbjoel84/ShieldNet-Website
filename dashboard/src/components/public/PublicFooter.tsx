        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><a href="/privacy.html" className="text-sm text-muted-foreground hover:text-green-400 transition-colors">Privacy Policy</a></li>
              <li><a href="/terms.html" className="text-sm text-muted-foreground hover:text-green-400 transition-colors">Terms of Service</a></li>
            </ul>
          </div>
