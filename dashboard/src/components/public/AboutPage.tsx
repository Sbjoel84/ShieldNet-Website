...
import { ShieldCheck, Target, Eye, Heart, Users, Wheat, Building2, Bot } from 'lucide-react'
...
const MILESTONES = [
  ...
  { year: '2024', event: 'Launched ShieldNet Properties with 200+ verified listings in Abuja.' },
  { year: '2024', event: 'ShieldFarm beta launched — 500 farmers onboarded in first month.' },
  { year: '2025', event: 'Expanded to Lagos. 1,000+ verified properties and ₦50B+ in transactions protected.' },
      ...
      <div className="bg-gradient-to-b from-green-500/10 to-transparent border-b border-border py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg leading-relaxed">
            We're on a mission to make every real estate and agricultural transaction in Nigeria safe, transparent, and AI-verified.
          </p>
        </div>
      </div>
