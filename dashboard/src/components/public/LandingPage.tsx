...
import { ShieldCheck, Building2, Wheat, ArrowRight, CheckCircle2, Users, BarChart3, Star } from 'lucide-react'
import { Button } from '@/components/ui/button'
import type { LucideIcon } from 'lucide-react'

type ServiceItem = {
  to: string; color: string; bg: string; border: string; title: string; desc: string; cta: string
...
const SERVICES: ServiceItem[] = [
  {
    ...
    title: 'ShieldNet AI',
    desc: 'Nigeria\'s most advanced AI security platform — real-time threat intelligence, fraud detection, identity verification, and risk scoring for individuals and enterprises.',
  ...
  },
  {
    ...
    title: 'ShieldFarm',
    desc: 'AI crop diagnosis, real-time market prices, farm diary management, and expert agronomist consultations for Nigerian farmers.',
  ...
  },
  {
    ...
    title: 'ShieldNet Properties',
    desc: 'Browse verified real estate listings with AI-powered fraud detection and Shield Verified badges. Buy, rent, or invest with confidence.',
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-24 text-center w-full">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6 max-w-4xl mx-auto">
            ...
            <span className="text-green-400">Protected by AI</span>
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            ShieldNet Core Technologies uses advanced AI to verify properties, diagnose crops, and protect millions of Nigerians from fraud — in real time.
          </p>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">Three powerful platforms, one shield. Built for Nigerian buyers, farmers, and agents.</p>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {SERVICES.map(s => (
            <Link
              key={s.to}
              to={s.to}
              className={`group p-6 rounded-2xl border ${s.border} ${s.bg} hover:scale-[1.02] transition-transform`}
            >
              ...
              <span className={`text-sm font-medium ${s.color} flex items-center gap-1 group-hover:gap-2 transition-all`}>
