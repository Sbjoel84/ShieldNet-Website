...
import { Upload, Leaf, AlertCircle, CheckCircle2, Clock, Loader2, Bot } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { Badge } from '@/components/ui/badge'
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card'
import { SEED_DIAGNOSES } from '@/data/seedData'
import { formatDate } from '@/lib/utils'
import type { CropDiagnosis as Diag } from '@/lib/types'

const MOCK_RESULTS: Record<string, Omit<Diag, 'id' | 'farm_id' | 'image_url' | 'created_at' | 'status'>> = {
  default: {
          ...
          {!preview ? (
            ...
            <div className="space-y-4">
              <div className="relative rounded-xl overflow-hidden">
                ...
                <button onClick={reset} className="absolute top-2 right-2 bg-black/60 text-white text-xs px-2 py-1 rounded-lg hover:bg-black/80">
                  Remove
                </button>
              </div>
              {!result && (
